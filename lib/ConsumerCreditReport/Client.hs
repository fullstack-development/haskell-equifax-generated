...
module ConsumerCreditReport.Client where
...
dispatchLbs
  ...
  -> ConsumerCreditReportConfig -- ^ config
  -> ConsumerCreditReportRequest req contentType res accept -- ^ request
