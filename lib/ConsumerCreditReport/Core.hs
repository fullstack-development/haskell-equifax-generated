...
{-|
Module : ConsumerCreditReport.Core
-}
...
module ConsumerCreditReport.Core where

import ConsumerCreditReport.MimeTypes
import ConsumerCreditReport.Logging
...
-- | display the config
instance P.Show ConsumerCreditReportConfig where
  show c =
    T.printf
...
-- | constructs a default ConsumerCreditReportConfig
--
-- configHost:
--
-- @https://api.sandbox.equifax.com/business/consumer-credit/v1@
--
-- configUserAgent:
--
-- @"consumer-credit-report/0.1.0.0"@
--
newConfig :: IO ConsumerCreditReportConfig
newConfig = do
    logCxt <- initLogContext
    return $ ConsumerCreditReportConfig
        { configHost = "https://api.sandbox.equifax.com/business/consumer-credit/v1"
        , configUserAgent = "consumer-credit-report/0.1.0.0"
...
addAuthMethod config@ConsumerCreditReportConfig {configAuthMethods = as} a =
  config { configAuthMethods = AnyAuthMethod a : as}

-- | updates the config to use stdout logging
withStdoutLogging :: ConsumerCreditReportConfig -> IO ConsumerCreditReportConfig
...
withStderrLogging :: ConsumerCreditReportConfig -> IO ConsumerCreditReportConfig
...
data ConsumerCreditReportRequest req contentType res accept = ConsumerCreditReportRequest
  { rMethod  :: NH.Method   -- ^ Method of ConsumerCreditReportRequest
  , rUrlPath :: [BCL.ByteString] -- ^ Endpoint of ConsumerCreditReportRequest
  , rParams   :: Params -- ^ params of ConsumerCreditReportRequest
  , rAuthTypes :: [P.TypeRep] -- ^ types of auth methods
  }
  deriving (P.Show)

-- | 'rMethod' Lens
rMethodL :: Lens_' (ConsumerCreditReportRequest req contentType res accept) NH.Method
rMethodL f ConsumerCreditReportRequest{..} = (\rMethod -> ConsumerCreditReportRequest { rMethod, ..} ) <$> f rMethod
{-# INLINE rMethodL #-}

-- | 'rUrlPath' Lens
rUrlPathL :: Lens_' (ConsumerCreditReportRequest req contentType res accept) [BCL.ByteString]
rUrlPathL f ConsumerCreditReportRequest{..} = (\rUrlPath -> ConsumerCreditReportRequest { rUrlPath, ..} ) <$> f rUrlPath
{-# INLINE rUrlPathL #-}

-- | 'rParams' Lens
rParamsL :: Lens_' (ConsumerCreditReportRequest req contentType res accept) Params
rParamsL f ConsumerCreditReportRequest{..} = (\rParams -> ConsumerCreditReportRequest { rParams, ..} ) <$> f rParams
{-# INLINE rParamsL #-}

-- | 'rParams' Lens
rAuthTypesL :: Lens_' (ConsumerCreditReportRequest req contentType res accept) [P.TypeRep]
rAuthTypesL f ConsumerCreditReportRequest{..} = (\rAuthTypes -> ConsumerCreditReportRequest { rAuthTypes, ..} ) <$> f rAuthTypes
{-# INLINE rAuthTypesL #-}
...
class HasBodyParam req param where
  setBodyParam :: forall contentType res accept. (Consumes req contentType, MimeRender contentType param) => ConsumerCreditReportRequest req contentType res accept -> param -> ConsumerCreditReportRequest req contentType res accept
  setBodyParam req xs =
...
class HasOptionalParam req param where
  ...
  applyOptionalParam :: ConsumerCreditReportRequest req contentType res accept -> param -> ConsumerCreditReportRequest req contentType res accept
  applyOptionalParam = (-&-)
  {-# INLINE applyOptionalParam #-}

  -- | infix operator \/ alias for 'addOptionalParam'
  (-&-) :: ConsumerCreditReportRequest req contentType res accept -> param -> ConsumerCreditReportRequest req contentType res accept
  (-&-) = applyOptionalParam
  {-# INLINE (-&-) #-}
...
setHeader ::
     ConsumerCreditReportRequest req contentType res accept
  -> [NH.Header]
  -> ConsumerCreditReportRequest req contentType res accept
...
removeHeader :: ConsumerCreditReportRequest req contentType res accept -> [NH.HeaderName] -> ConsumerCreditReportRequest req contentType res accept
...
class P.Typeable a =>
  ...
  applyAuthMethod
    ...
    -> a
    -> ConsumerCreditReportRequest req contentType res accept
    -> IO (ConsumerCreditReportRequest req contentType res accept)
...
_applyAuthMethods
  ...
  -> ConsumerCreditReportConfig
  -> IO (ConsumerCreditReportRequest req contentType res accept)
_applyAuthMethods req config@(ConsumerCreditReportConfig {configAuthMethods = as}) =
  foldlM go req as
  where
