...
module ConsumerCreditReport.Logging
  ( module ConsumerCreditReport.LoggingKatip
  ) where

import ConsumerCreditReport.LoggingKatip

#else

module ConsumerCreditReport.Logging
  ( module ConsumerCreditReport.LoggingMonadLogger
  ) where

import ConsumerCreditReport.LoggingMonadLogger
